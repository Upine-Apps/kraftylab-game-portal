...
export default function SlideShowButton(props) {
    ...
    return (
        <Wrapper>
            <IconWrapper>
                <Icon src="/images/icons/arrow-icon.svg" className="icon" rotateDirection={degrees} />
            </IconWrapper>
        </Wrapper>
    )
}
...
display: grid;
  ...
  justify-self: center;
border-radius: 100px;
background: linear-gradient(180deg, rgba(123, 123, 123, 0.3) 0%, rgba(217, 217, 217, 0) 100%);
