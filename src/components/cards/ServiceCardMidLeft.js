  ...
  return (
    <Wrapper>
      ...
      <div className="content-card">
        <TextWrapper>
          <Title>Web</Title>
          <Subtitle>From Apps to Sites</Subtitle>
          <SubServiceWrapper>
            <SubServiceRow>
            ...
            <SubServiceRow>
              <img src="/images/icons/check-dark.svg" />
              <SubService>Hosting and Security</SubService>
            </SubServiceRow>
            <SubServiceRow>
              <img src="/images/icons/check-dark.svg" />
              <SubService>Progressive Web Apps</SubService>
            </SubServiceRow>
            <SubServiceRow>
              <img src="/images/icons/check-dark.svg" />
              <SubService>Modern Frameworks</SubService>
            </SubServiceRow>
          </SubServiceWrapper>
        </TextWrapper>
